...
const pages = {
    ...
    onlineStore: () => import('@/pages/OnlineStore'),
    ...
    integrationsAPI: () => import('@/pages/IntegrationsAPI'),
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { path: '/online-store', element: page(pages.onlineStore) },
                    ...
                    { path: '/integrations-api', element: page(pages.integrationsAPI) },
